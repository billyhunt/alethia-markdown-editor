...
export const IPC = {
  ...
  recentsListFolders: 'recents:listFolders',
  recentsAddFolder: 'recents:addFolder',
  recentsClearFolders: 'recents:clearFolders',
  ...
  menuFolderSwitcher: 'menu:folderSwitcher',
